    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_name', models.CharField(blank=True, help_text='Short name of the project', max_length=50, null=True, verbose_name='Project short name')),
                ('begin_date', models.DateField(verbose_name='Begin date')),
                ('end_date', models.DateField(verbose_name='End date')),
                ('goals_block', wagtail.fields.StreamField([('goal', wagtail.blocks.StructBlock([('heading', wagtail.blocks.CharBlock()), ('description', wagtail.blocks.RichTextBlock(features=['bold', 'ul', 'ol', 'link', 'superscript', 'subscript'])), ('image', wagtail.images.blocks.ImageChooserBlock(required=False))]))], blank=True, null=True, use_json_field=True, verbose_name='Goals')),
                ...
                ('partners', modelcluster.fields.ParentalManyToManyField(blank=True, related_name='projects', to='partners.partner', verbose_name='Partners')),
        ...
        migrations.AddField(
            ...
            name='services',
            field=modelcluster.fields.ParentalManyToManyField(related_name='projects', through='projects.ServiceProject', to='base.servicecategory', verbose_name='Services'),
        ),
        migrations.AddField(
            model_name='projectpage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('introduction_text', wagtail.fields.RichTextField(help_text='Introduction section description', verbose_name='Introduction text')),
                ('introduction_button_text', models.TextField(blank=True, max_length=20, null=True, verbose_name='Introduction button text')),
                ('items_per_page', models.PositiveIntegerField(default=6, help_text='How many items should be visible on the projects landing page filter section ?', validators=[django.core.validators.MinValueValidator(6), django.core.validators.MaxValueValidator(20)], verbose_name='Items per page')),
                ('banner_image', models.ForeignKey(blank=True, help_text='A high quality banner image', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.image', verbose_name='Banner Image')),
                ('call_to_action_related_page', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailcore.page', verbose_name='Call to action related page')),
                ('introduction_button_link', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailcore.page', verbose_name='Introduction button link')),
                ('introduction_image', models.ForeignKey(blank=True, help_text='A high quality image', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.image', verbose_name='Introduction Image')),
