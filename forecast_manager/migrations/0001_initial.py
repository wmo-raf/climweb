    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_name', models.CharField(blank=True, help_text='Weather Condition Short Name (helpgul for yr.no weather api)', max_length=50, null=True, verbose_name='Weather Condtion Short Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition', models.ForeignKey(help_text='E.g Light Showers', on_delete=django.db.models.deletion.CASCADE, to='forecast_manager.conditioncategory', verbose_name='General Weather Condition')),
            ],
            options={
