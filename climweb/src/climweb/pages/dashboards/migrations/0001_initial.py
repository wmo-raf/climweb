    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('selected_datetime', models.DateTimeField(blank=True, help_text='If applicable, select the time slice to display for this dataset.', null=True, verbose_name='Selected Timestamp')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chart_type', models.CharField(choices=[('line', 'Line Chart'), ('bar', 'Bar Chart'), ('stripes', 'Warming stripes')], default='line', max_length=10)),
