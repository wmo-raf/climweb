...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0018_productindexpage_group_menu_items_by_service_and_more'),
    ]
