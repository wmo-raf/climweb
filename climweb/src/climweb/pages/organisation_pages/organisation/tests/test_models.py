...
from .factories import OrganisationIndexPageFactory


class TestOrganisationIndexPage(WagtailPageTestCase):
    @classmethod
    def setUpTestData(cls):
        home_page = get_or_create_homepage()
        cls.page = OrganisationIndexPageFactory(parent=home_page)
