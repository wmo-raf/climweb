...
from .decode import identify_message_type, parse_metar_message, parse_taf_message
from .forms import AirportLoaderForm, MessageForm
from .models import Airport, Message, AirportCategory
                        ...
                        if airport_code:
                            ...
                            if airport:
                                ...
                                data = {
                                    ...
                                    'msg_datetime': datetime.strptime(decoded_message.get('datetime'),
                                                                      '%Y-%m-%d %H:%M:%S UTC')
                                }
        ...
        if form.is_valid():
            ...
            for airport in airports:
                ...
                if airport_exists:
                    ...
                    airport_obj = Airport(id=id, name=airport_name, location=Point(x=lon, y=lat, srid=4326),
                                          category=AirportCategory.objects.get(name__iexact=category))
                    airport_obj.save()
