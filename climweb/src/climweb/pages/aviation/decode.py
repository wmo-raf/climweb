            ...
            "trends": [
                {
                    ...
                    "start_date": fmt_date('TAF', trend.validity.start_day,
                                           time(trend.validity.start_hour, 0, 0)).strftime(
                        '%Y-%m-%d %H:%M:%S UTC') if trend._validity else None,
                    "end_date": fmt_date('TAF', trend.validity.end_day, time(trend.validity.end_hour, 0, 0)).strftime(
                        '%Y-%m-%d %H:%M:%S UTC') if trend._validity else None,
                    "wind": {
                        "direction": {
