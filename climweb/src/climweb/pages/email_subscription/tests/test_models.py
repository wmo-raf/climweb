...
from .factories import MailchimpMailingListSubscriptionPageFactory


class TestMailchimpMailingListSubscriptionPage(WagtailPageTestCase):
    @classmethod
    def setUpTestData(cls):
        home_page = get_or_create_homepage()
        
        cls.page = MailchimpMailingListSubscriptionPageFactory(parent=home_page)
